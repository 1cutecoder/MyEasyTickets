...
public class MainPay {
    private static Log                  log = LogFactory.getLog(MainPay.class);
    ...
    static {
         ...
         */
        Configs.init("src/test/zfbinfo.properties");
    ...
    /*public static String pay() {
        ...
        realPath = main.test_trade_precreate();
        return realPath;
    }*/
    ...
    // 测试当面付2.0查询订单
    public boolean test_trade_query() {
    ...
    public String test_trade_precreate() {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("D:\\temp/qr-%s.png",
