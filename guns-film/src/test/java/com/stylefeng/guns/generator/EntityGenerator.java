...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("F:\\JAVAEE\\guns\\guns-film\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"mtime_film_info_t","mtime_film_t","mtime_source_dict_t","mtime_year_dict_t"});
