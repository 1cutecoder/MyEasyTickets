...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\workspace\\guns\\guns-cinema\\src\\main\\java");//这里写你自己的java目录
        gc.setFileOverride(false);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("cutecoder");
        ...
        dsc.setPassword("24345839");
        dsc.setUrl("jdbc:mysql://localhost:3306/easytickets?serverTimezone=GMT&characterEncoding=utf8");
